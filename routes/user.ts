 ...
 *                 message:
 *                   type: string
 *                   example: You can only update your profile
 *       500:
 *         description: Internal server error
 *         content:
 *           application/json:
 ...
 *                 message:
 *                   type: string
 *                   example: Unauthorized Access ! You can only access your profile
 *       404:
 *         description: User not found
 *         content:
 *           application/json:
 ...
 *                       vendor:
 *                         type: string
 *                         description: Reference to User model (vendor)
 *                       status:
 *                         type: string
 ...
 *                       cart:
 *                         type: string
 *                         description: Reference to Cart model
 *                       createdAt:
 *                         type: string
 *                         format: date-time
 *                       updatedAt:
 ...
 *                 message:
 *                   type: string
 *                   example: Unauthorized Access ! You can only access your orders
 *       404:
 *         description: User not found
 *         content:
 *           application/json:
